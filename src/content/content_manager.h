...
public:
    ...
    void invalidateTask(unsigned int taskID, task_owner_t taskOwner = ContentManagerTask) const;
    ...
    void addObject(const std::shared_ptr<CdsObject>& obj, bool firstChild) const;
    ...
    void updateObject(const std::shared_ptr<CdsObject>& obj, bool sendUpdates = true) const;
    ...
    void handlePersistentAutoscanRecreate(const std::shared_ptr<AutoscanDirectory>& adir) const;
    ...
    void triggerPlayHook(const std::string& group, const std::shared_ptr<CdsObject>& obj) const;
...
protected:
    ...
    void updateItemData(const std::shared_ptr<CdsItem>& item, const std::string& mimetype) const;
